            ...
            <div className='flex'>
                <div className='flex flex-col w-1/3 justify-around py-8'>
                    <Link className='flex items-center hover:underline' onMouseOver={() => {showLine(1)}} onFocus={() => {showLine(1)}} to="/projects">
                        ...
                        <svg id='line-1' className='pl-2' width="177" height="6" viewBox="0 0 177 6" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M177 6H0V0H177V6Z" fill="#223043"/></svg>
                    </Link>
                    <Link className='flex items-center hover:underline' onMouseOver={() => {showLine(2)}} onFocus={() => {showLine(2)}} to="/about">
                ...
                <div className='flex-col h-64 mt-10 font-normal w-full border-solid border-l-4 border-navy '>
                    ...
                    <div id='text-3' className='hidden'>
                        ...
                        I also cross-post on <a className='blue-link' href='https://dev.to/pickleat'>Dev.to</a></p>
