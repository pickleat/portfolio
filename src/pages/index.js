...
export default () => (
    ...
    <div className='mx-auto max-w-3xl'>
        <div className='flex h-full items-end'>
            <h1 className='ml-8 px-2 border-solid border-t-4 border-r-4 border-l-4 border-yellow-100'>Andy Pickle</h1>
            ...
            <div className='flex'>
                ...
                <div className='flex-col w-1/2 p-4'>
                    <p className=''><b>Something about me:</b><br />I'm passionate about building things on the web that people 
                        ...
                        what I think you can read my <a href="blog/">blog</a>. If you want to see what I've built 
                        check out my <a href="/projects/">projects</a>, if you're interested in hiring me, check 
                        out my resume, or if you want to work together, get in <a href='/contact'>touch!</a>
                    </p>
