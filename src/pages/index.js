...
export default ({data}) => {
    ...
    <div className='mx-auto w-full md:max-w-3xl'>
        ...
        <div className='bg-yellow-100 text-navy px-10 pb-10 w-full md:max-w-6xl'>
            <h2 className='text-3xl text-navy font-bold lowercase tracking-wide'>frontend developer</h2>
            <div className='flex'>
                <div className='flex flex-col w-1/3 justify-around py-8'>
                    <Link className='flex items-center hover:underline' onMouseOver={() => {showLine(1)}} onFocus={() => {showLine(1)}} to="/projects">
                        <svg className="flex-shrink-0 stroke-current h-4 w-4" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='flex-col p-4 h-64 mt-10 font-normal'>
                    ...
                    <div id='text-4' className='hidden'>
                        <div className='w-full'>
                            <h3 className='text-center text-2xl font-bold'>Contact</h3>
                            <ul>
                                <li>
                                    <a href='https://twitter.com/pickleat' className='blue-link'>Twitter</a>
                                </li>
                                <li>
                                    <a href='https://www.linkedin.com/in/andy-pickle/' className='blue-link'>LinkedIn</a>
                                </li>
