...
const Contact = () => {
    ...
    fetch("/", {
        ...
        body: encode({ "form-name": "portfolioSiteContact", ...formData })
    })
            ...
            <div className='bg-yellow-50 text-navy px-10 pb-10 w-full md:max-w-6xl'>
                ...
                {submitted && 
                    <div className='text-center p-8'>
                        ...
                        While, you're here, check out some of my 
                        <Link className='blue-link' to='/blog/'> writing</Link>. 
                    </div>
                }
                {!submitted && 
                    <form className='my-4 sm:mx-12 sm:p-4 flex flex-col'
                        name="portfolioSiteContact"
                        method="post"
                        data-netlify="true"
