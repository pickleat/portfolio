...
export default () => (
    <Layout>
    <div>
        <h3><i>I'm currently open to job offers for full-time or contract web-development work.</i></h3>
        <p>If you get in touch, I would love to send you my resume.
            <br></br>Feel free to get in touch with me through any of the following platforms!
        </p>
