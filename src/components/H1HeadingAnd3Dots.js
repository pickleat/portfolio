...
function Heading(props){
    ...
    return(
        <div className='flex h-full items-end'>
            <div className='flex flex-shrink ml-8 pr-10 leading-none py-2 sm:py-0 px-2 border-solid border-t-2 sm:border-t-4 border-r-2 sm:border-r-4 border-l-2 sm:border-l-4 border-yellow-100 items-center'>
                {props.svg ? getSVG() : null}
                <h1 className='pl-4 text-2xl sm:text-6xl text-yellow-100 tracking-tight uppercase'>{props.title || getURLName()}</h1>
            </div>
            <span className='hidden md:flex md:items-center md:px-2 md:h-10 md:border-solid md:border-t-4 md:border-r-4 md:border-yellow-100 md:text-yellow-100 md:font-extrabold'>
