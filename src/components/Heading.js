...
function Heading(props){
    ...
    return(
        <div className='flex h-full items-end'>
            <div className='flex ml-8 pr-10 leading-none px-2 border-solid border-t-4 border-r-4 border-l-4 border-yellow-100 items-center'>
                {props.svg ? getSVG() : null}
                <h1 className='pl-4'>{props.title || getURLName()}</h1>
            </div>
